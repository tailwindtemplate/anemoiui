...
export const WaitingItem = ({avatar}: WaitingItem) => {
    ...
    return (
        <div className='relative group cursor-pointer'>
            ...
            <div className='w-40 rounded-md bg-white shadow-sm overflow-hidden p-2 flex flex-col opacity-0 group-hover:opacity-100 absolute right-16 top-0'>
                <Subtitle1 className='truncate'>Name Name Name Name</Subtitle1>
                <Body2 className='truncate'>Last message Last message Last message</Body2>
            </div>
        </div>
    );
};
