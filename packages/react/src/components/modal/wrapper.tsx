        ...
        <Transition.Root show={open} as={Fragment}>
            <Dialog as="div" static className="fixed z-10 inset-0 overflow-y-auto" open={open} onClose={setOpen}>
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                        <div className={clsx('relative inline-block align-bottom rounded-sm px-4 pt-5 pb-4 text-left shadow-xl transform transition-all sm:my-8 sm:align-middle max-w-sm sm:w-full sm:p-6 lg:max-w-lg', theme == 'light' ?  'bg-white' : 'bg-black text-white')}>
