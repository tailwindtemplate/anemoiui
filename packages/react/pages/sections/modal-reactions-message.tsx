import { Modal, Section, TabControl, TabPanel, UserCard } from '../../src';
import { useMemo, useState } from 'react';
import { tabItems } from "../../const";

export default function ModalReactionsMessage() {
